      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-4 sm:p-6 shadow-xl space-y-3.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 sm:gap-3 items-end">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 sm:py-2.5 bg-slate-950 border border-slate-700 rounded-2xl text-xs text-white focus:outline-none focus:border-orange-500"
            >
              {places.map(p => (
          ...
          <div>
            <a
              ...
              className="w-full py-2.5 px-4 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 text-white rounded-2xl text-xs font-bold shadow-md shadow-orange-500/20 flex items-center justify-center gap-2 transition-transform active:scale-95 text-center"
            >
        ...
        {fromPlace && toPlace && (
          <div className="bg-slate-950/70 border border-slate-800 p-3 rounded-2xl text-xs text-slate-300 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            ...
            <ArrowRight className="w-3.5 h-3.5 text-orange-400 shrink-0 hidden sm:block" />
            <div className="flex items-center gap-1.5 truncate">
